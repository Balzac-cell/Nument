...
def app():
        ...
        if Number :
            ...
            try:
                ...
                if response.status_code == 204:  # 204 = Modification réussie
                    ...
                    st.session_state["page"] = "page3"  # Rediriger vers page3
                    st.rerun()
                else:
    ...
    with col2:
        try:
            ...
            st.image("app4/assets/Split/Number/SplitNumber.jpg", caption="Bloc 2 sur 6", use_container_width=True
)
        except FileNotFoundError:
            st.warning("Image non trouvée.")
